package com.dev.alahlifc.al_ahlysportsclub.Coach
...
import com.dev.alahlifc.al_ahlysportsclub.databinding.ActivityCoachBinding
import com.dev.alahlifc.al_ahlysportsclub.models.mFootballTeam
import timber.log.Timber


class CoachActivity : LocalizationActivity() {

    private lateinit var binding: ActivityCoachBinding
    private var player : mFootballTeam.Coache ? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_coach)
    ...
    private fun changeViewsFonts() {
        Util.changeViewTypeFace(this@CoachActivity,
