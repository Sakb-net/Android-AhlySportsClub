...
class NewsDetailsCommentsAdapter(private val mutableList: MutableList<mComments.Data?>, private val video_link : String) :
    RecyclerView.Adapter<NewsDetailsCommentsAdapter.ViewHolder>() {
