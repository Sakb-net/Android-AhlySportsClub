...
class selectFeesAdapter(private val mutableList: ArrayList<mItemsInCategory.Fee>) :
    RecyclerView.Adapter<selectFeesAdapter.ViewHolder>() {
   ...
   fun getListAfterEdit() = mutableList
    ...
    inner class ViewHolder(val v: View) : RecyclerView.ViewHolder(v) {
        ...
        fun bind(fee: mItemsInCategory.Fee) {
