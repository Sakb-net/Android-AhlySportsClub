package com.dev.alahlifc.al_ahlysportsclub.ProductDetails.bottomsheetbuy
...
class BottomBuyDetailsFragment : BottomSheetDialogFragment() {

    private lateinit var binding : BottomBuyNewestFragmentBinding
    private lateinit var viewModel: BottomBuyDetailsViewModel
    private  var newItemArgs  : mProductSingle.Data? = null

    private  var result : ArrayList<mProduct.Fee>? = null
    private  var printName :String? = ""
    private lateinit var adapter: SelectDSizeAdapter
    private lateinit var adapterColor: SelectDColorAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        newItemArgs = arguments?.getParcelable("detailsItem")
   ...
   /** private fun changeViewsFonts() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(BottomBuyDetailsViewModel::class.java)
        ...
        Thread(Runnable {
            ...
            handler.postDelayed(Runnable {
                adapter =  SelectDSizeAdapter(mModelList)
                binding.mRecyclerView.adapter = adapter


                adapterColor =  SelectDColorAdapter(mColorModelList)
                ...
                binding.show.setOnClickListener{
                    startActivityForResult(Intent(context, SelectFeesActivity::class.java)
                        .putExtra("detailsItem",newItemArgs),1)
